...
const reasons = [
  {
    ...
    description:
      'SEBI registered advisors providing conflict-free expert guidance.',
  },
  {
    icon: HeartHandshake,
    title: 'Personalized Care',
    description:
      'Tailored investment solutions for your unique financial goals.',
  },
  {
    icon: Brain,
...
const testimonials = [
  {
    quote:
      'DEEPSEA FINVEST helped me build a diversified portfolio delivering consistent returns. Their expertise in high yield bonds is unmatched.',
    author: 'Rajesh Kumar',
  ...
  {
    quote:
      'Professional, transparent, and always available. They truly understand the needs of NRIs and seafarers like me.',
    author: 'Priya Sharma',
    role: 'Business Owner',
    image:
  ...
  {
    quote:
      "I've grown my wealth by 3x in 5 years with their guidance. The bond investments have been phenomenal.",
    author: 'Anil Mehta',
  ...
  {
    quote:
      "Their financial planning helped me secure my family's future. Best investment decision I ever made.",
    author: 'Dr. Sunita Rao',
    role: 'Doctor',
    image:
      'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=80&h=80&fit=crop&crop=face&q=80',
  },
  {
    quote:
      'Best wealth management firm in Mumbai. The team is knowledgeable and always puts clients first.',
    author: 'Vikram Singh',
    role: 'Pilot',
    image:
  ...
  {
    quote:
      'The SIP and mutual fund recommendations have significantly outperformed my expectations. Highly recommended!',
    author: 'Meena Patel',
    role: 'NRI - Singapore',
    image:
  ...
  {
    quote:
      'Their pre-IPO investment picks gave phenomenal returns. Very trustworthy and transparent team.',
    author: 'Arjun Nair',
    role: 'Business Owner',
    image:
      'https://images.unsplash.com/photo-1463453091185-61582044d556?w=80&h=80&fit=crop&crop=face&q=80',
  },
  {
    quote:
      'Insurance planning gave me complete peace of mind. Professional and efficient service every time.',
    author: 'Kavya Reddy',
    role: 'Marine Engineer',
    image:
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-white/60 text-base md:text-lg max-w-2xl mx-auto">
            Expert financial guidance tailored for Marine Engineers, NRIs,
        ...
        <div className="grid lg:grid-cols-5 gap-6 lg:gap-10 items-center mb-20">
          ...
          <div className="lg:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4">
            {reasons.map(reason => (
              <div
                key={reason.title}
                className="glass-card p-4 rounded-xl card-hover-lift group"
              >
