...
const services = [
  {
    ...
    description:
      'Our Forte - 8-15% market yield opportunities with direct exchange purchase at best available market yield. Corporate bonds, NCDs & Government securities.',
  ...
  },
  {
    ...
    description:
      'MLDs - Equity-linked structured products combining debt structure with equity-linked returns. Tax-efficient wealth creation strategy.',
    href: '/fixed-income/fixed-income-products',
    image:
  ...
  },
  {
    ...
    description:
      'Pre-IPO Opportunities in NSE, MSEI, CSK & more. Invest in promising companies before they go public for potential high returns.',
    href: '/equity',
    image:
  ...
  },
  {
    ...
    description:
      'Professional trading platforms with seamless demat services. Diversified portfolios through SIP, lumpsum & goal-based investing strategies.',
  ...
  },
  {
    ...
    description:
      'AIFs and Commercial real estate strategies with exclusive premium investment opportunities. PMS, REITS & structured products for HNIs.',
    href: '/alternates',
    image:
  ...
  },
  {
    ...
    description:
      "Comprehensive life & general insurance coverage, will writing & succession planning to secure your family's financial future.",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-white/60 text-base md:text-lg max-w-2xl mx-auto">
            Comprehensive wealth management solutions across various financial
            asset classes for professionals, NRIs & HNIs
          </p>
        </div>
