...
export default function AdminLeadsPage() {
  ...
  useEffect(() => {
    ...
    if (typeFilter !== 'all')
      result = result.filter(
        l => l.type === typeFilter || l.source === typeFilter
      );
    setFiltered(result);
    setPage(1);
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="new" className="bg-[#0f172a] text-white">
                    New
                  </option>
                  <option value="contacted" className="bg-[#0f172a] text-white">
                    Contacted
                  </option>
                  <option value="qualified" className="bg-[#0f172a] text-white">
                    Qualified
                  </option>
                  <option value="converted" className="bg-[#0f172a] text-white">
                    Converted
                  </option>
                  <option value="lost" className="bg-[#0f172a] text-white">
                    Lost
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="form" className="bg-[#0f172a] text-white">
                    Form
                  </option>
                  <option value="popup" className="bg-[#0f172a] text-white">
                    Popup
                  </option>
                  <option value="whatsapp" className="bg-[#0f172a] text-white">
                    WhatsApp
                  </option>
                  <option value="phone" className="bg-[#0f172a] text-white">
                    Phone
                  </option>
                </select>
              </div>
                    ...
                    <tbody>
                      {paginated.map(lead => (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <span
                              className={`px-2 py-0.5 rounded text-xs font-medium ${TYPE_COLORS[lead.type || 'form'] || TYPE_COLORS.form}`}
                            >
                              {(lead.type || 'form').charAt(0).toUpperCase() +
                                (lead.type || 'form').slice(1)}
                            </span>
                          </td>
