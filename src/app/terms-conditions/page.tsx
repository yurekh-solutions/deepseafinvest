        ...
        <GlassCard className="p-8 md:p-12" elevated>
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-white/60">Rules and regulations for using our services</p>
            </div>
          </div>
          ...
          <div className="space-y-8 text-white/70">
            <section>
              ...
              <p className="leading-relaxed">
                By accessing and using the DEEPSEA FINVEST website and services, you accept and agree 
            ...
            <section>
              <h3 className="text-xl font-semibold text-white mb-3">Use of Services</h3>
            ...
            <section>
              <h3 className="text-xl font-semibold text-white mb-3">Investment Services</h3>
              <p className="leading-relaxed">
                Our investment recommendations and advice are based on information provided by you 
                and our analysis of market conditions. All investments carry risk, and past performance 
                is not indicative of future results. You are solely responsible for your investment decisions.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                property of DEEPSEA FINVEST and is protected by copyright and other intellectual 
            ...
            <section>
              <h3 className="text-xl font-semibold text-white mb-3">Fees and Charges</h3>
              <p className="leading-relaxed">
                Details of fees and charges for our services are available upon request. We reserve 
                the right to modify our fee structure with prior notice. All fees are exclusive of 
            ...
            <section>
              ...
              <p className="leading-relaxed">
                To the maximum extent permitted by law, DEEPSEA FINVEST shall not be liable for any 
            ...
            <section>
              ...
              <p className="leading-relaxed">
                You agree to indemnify and hold harmless DEEPSEA FINVEST and its officers, directors, 
