...
export default function FDCalculatorPage() {
  ...
  const maturityAmount =
    principal * Math.pow(1 + rate / 100 / compoundFreq, compoundFreq * years);
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-12">
        ...
        <p className="text-white/70 leading-relaxed mb-4">
          Fixed Deposits are one of India&apos;s most popular and trusted
          investment instruments. They offer guaranteed returns, capital safety,
          and flexible tenures — making them ideal for conservative investors
          seeking predictable income. FDs are backed by the bank or NBFC and
          offer returns ranging from 5.5% to 9.5% depending on the issuer and
          tenure.
        </p>
        <p className="text-white/60 leading-relaxed mb-6">
          Use our FD Calculator to compare maturity amounts across different
          interest rates and tenures. Whether you are looking for a short-term
          parking option or a multi-year investment, this calculator helps you
          make an informed decision.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-left">
          {[
            { label: 'Bank FD returns', value: '5.5–7.5% p.a.' },
            { label: 'Corporate FD returns', value: '7.5–9.5% p.a.' },
            { label: 'Min deposit', value: '₹1,000' },
            { label: 'Tenure range', value: '7 days –10 years' },
          ].map(item => (
            <div
              key={item.label}
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {Array.from({ length: Math.min(years, 10) }, (_, i) => {
                ...
                const amount =
                  principal *
                  Math.pow(1 + rate / 100 / compoundFreq, compoundFreq * year);
                return (
