...
export const metadata: Metadata = {
  ...
  description:
    'Invest in high-yield fixed income products: corporate FDs, government bonds, tax-free bonds, debentures and PPF. Stable returns with capital protection. DEEPSEA FINVEST Mumbai.',
  keywords:
    'fixed income investment India, corporate fixed deposits, high yield bonds, government bonds, tax free bonds, debentures, PPF, stable returns, capital protection Mumbai',
};
...
const products = [
  {
    ...
    description:
      'Higher returns than bank FDs with flexible tenure options from reputed companies.',
    returns: '7.5% - 9.5%',
    tenure: '1 - 5 years',
  ...
  },
  {
    ...
    description:
      'Safe and secure investment option with guaranteed returns and deposit insurance.',
    returns: '5.5% - 7.5%',
  ...
  },
  {
    ...
    description:
      'Sovereign-backed securities offering safety and stable returns for conservative investors.',
    returns: '6.5% - 7.5%',
    tenure: '5 - 40 years',
    minInvestment: '₹1,000',
  },
  {
    ...
    description:
      'Earn tax-free interest income with AAA-rated PSU bonds for high-net-worth individuals.',
    returns: '5.5% - 6.5%',
    tenure: '10 - 20 years',
  ...
  },
  {
    ...
    title: 'Debentures',
    description:
      'Secured and unsecured debentures offering higher yields than traditional deposits.',
    returns: '8% - 11%',
    tenure: '1 - 10 years',
  ...
  },
  {
    ...
    description:
      'Tax-efficient long-term savings scheme with sovereign guarantee and EEE tax status.',
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-16">
        <p className="text-white/70 text-lg leading-relaxed">
          Fixed income investments provide stability and predictable returns to
          your portfolio. At DEEPSEA FINVEST, we offer a curated selection of
          fixed income products that balance safety, liquidity, and returns
          ...
          <ul className="space-y-4">
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">
                  Principal amount is protected with guaranteed returns
                </p>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">
                  Steady interest payouts for income needs
                </p>
              </div>
            </li>
            <li className="flex items-start">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">
                  Various tax-saving options available
                </p>
              </div>
            </li>
          </ul>
          ...
          <ul className="space-y-4">
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">
                  Seeking regular income with capital safety
                </p>
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">
                  Risk-averse individuals prioritizing safety
                </p>
              </div>
            </li>
            <li className="flex items-start">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">
                  Diversifying equity-heavy portfolios
                </p>
              </div>
            </li>
          </ul>
