...
const insuranceTypes = [
  {
    ...
    description: 'Comprehensive coverage for your vehicles including cars, bikes, and commercial vehicles.',
    features: ['Third-party liability', 'Own damage cover', 'Personal accident cover', 'Add-on riders'],
  },
  {
    icon: Home,
    title: 'Home Insurance',
    description: 'Protect your home and belongings against natural disasters, theft, and accidents.',
    features: ['Building coverage', 'Content coverage', 'Natural calamities', 'Fire protection'],
  },
  {
    icon: Heart,
    title: 'Health Insurance',
    description: 'Comprehensive health coverage for individuals and families with cashless facilities.',
    features: ['Cashless treatment', 'Pre & post hospitalization', 'Day care procedures', 'Annual health checkup'],
  },
  {
    icon: Plane,
    title: 'Travel Insurance',
    description: 'Travel worry-free with coverage for medical emergencies, trip cancellations, and baggage loss.',
  ...
  },
  {
    ...
    description: 'Business protection covering property, liability, and employee-related risks.',
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-16">
        <p className="text-white/70 text-lg leading-relaxed">
          General insurance provides financial protection against unforeseen events that could impact 
          your assets, health, and travels. At DEEPSEA FINVEST, we offer a wide range of general 
          insurance products to safeguard what matters most to you.
        </p>
      </div>
