...
const products = [
  {
    ...
    description:
      'Pure protection plan offering high coverage at affordable premiums.',
    benefits: [
      'High sum assured',
      'Low premiums',
      'Rider options',
  ...
  },
  {
    ...
    description:
      'Market-linked investment combined with life insurance protection.',
    benefits: [
      'Market returns',
      'Fund switching',
      'Partial withdrawal',
  ...
  },
  {
    ...
    description:
      'Guaranteed returns with life insurance coverage and bonus additions.',
    benefits: [
      'Guaranteed returns',
      'Bonus additions',
      'Loan facility',
  ...
  },
  {
    ...
    description:
      'Lifetime coverage with savings component and guaranteed benefits.',
    benefits: [
      'Lifetime coverage',
      'Cash value',
      'Dividend earnings',
  ...
  },
  {
    ...
    description:
      'Regular payouts during policy term with maturity and death benefits.',
    benefits: [
      'Regular payouts',
      'Survival benefits',
      'Death coverage',
  ...
  },
  {
    ...
    title: 'Child Plans',
    description:
      "Secure your child's future education and milestones with guaranteed benefits.",
    benefits: [
      'Education funding',
      'Waiver of premium',
      'Milestone payouts',
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-16">
        <p className="text-white/70 text-lg leading-relaxed">
          Choose from our wide range of life insurance products designed to
          provide financial security and help you achieve your long-term goals.
          Our expert advisors will help you select the perfect plan for your
          needs.
        </p>
      </div>
