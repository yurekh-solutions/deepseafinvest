...
const journeySteps = [
  {
    ...
    title: 'Discover',
    description:
      'Understand your current financial situation and identify your goals.',
  },
  {
    icon: Target,
    title: 'Plan',
    description:
      'Create a personalized roadmap to achieve your short and long-term objectives.',
  },
  {
    icon: Shield,
    title: 'Protect',
    description:
      'Secure your family and assets with appropriate insurance coverage.',
  },
  {
    icon: TrendingUp,
    title: 'Grow',
    description:
      'Invest wisely to build wealth and achieve financial independence.',
  },
];
...
const services = [
  ...
  },
  {
    ...
    description: 'Comprehensive protection for life and assets',
  },
  ...
  },
  {
    ...
    description: 'Achieve specific milestones with targeted investments',
  },
  {
    title: 'Portfolio Review',
    description: 'Regular monitoring and rebalancing of investments',
  },
];
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-16">
        <p className="text-white/70 text-lg leading-relaxed">
          Every financial journey is unique. At DEEPSEA FINVEST, we understand
          your aspirations and help you navigate the path to financial success.
          Whether you are just starting out or looking to optimize your existing
          portfolio, we are here to guide you every step of the way.
        </p>
      </div>
      ...
      <GlassCard className="p-8 md:p-12 text-center" elevated>
        ...
        <p className="text-white/70 mb-8 max-w-2xl mx-auto">
          Take the first step towards financial freedom. Schedule a free
