...
export const metadata: Metadata = {
  ...
  description:
    'Learn why SIP is the best way to invest in mutual funds. Rupee cost averaging, power of compounding, start with ₹500/month. Expert SIP advisory by DEEPSEA FINVEST Mumbai.',
  keywords:
    'why SIP investment, SIP benefits India, systematic investment plan, rupee cost averaging, power of compounding SIP, SIP mutual fund Mumbai, start SIP 500 rupees',
};
...
const benefits = [
  {
    ...
    description:
      'Automated monthly investments instill financial discipline and consistent wealth building.',
  },
  {
    icon: BarChart3,
    title: 'Rupee Cost Averaging',
    description:
      'Buy more units when prices are low and fewer when high, reducing average cost per unit.',
  },
  {
    icon: TrendingUp,
    title: 'Power of Compounding',
    description:
      'Earn returns on your returns, creating exponential wealth growth over time.',
  },
  {
    icon: Calendar,
    title: 'Flexible & Convenient',
    description:
      'Start with ₹500/month, choose any date, and modify or pause anytime.',
  },
  {
    icon: Shield,
    title: 'No Market Timing Needed',
    description:
      'Eliminate the stress of timing the market - invest regularly regardless of market conditions.',
  },
  {
    icon: Clock,
    title: 'Long-Term Wealth',
    description:
      'Ideal for achieving long-term goals like retirement, child education, or home buying.',
  },
];
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-16">
        <p className="text-white/70 text-lg leading-relaxed">
          ...
          regularly in mutual funds. It is the most disciplined and hassle-free
          way to build wealth over time, making it perfect for both beginners
      ...
      <GlassCard className="p-8" elevated>
        ...
        <div className="mt-8 p-6 bg-accent-red/10 rounded-xl text-center">
          ...
          <p className="text-4xl md:text-5xl font-bold text-accent-red">
            ₹99.9 Lakhs
          </p>
          <p className="text-white/40 text-sm mt-2">
            Total Investment: ₹24 Lakhs | Wealth Gain: ₹75.9 Lakhs
          </p>
        </div>
      </GlassCard>
    </PageLayout>
