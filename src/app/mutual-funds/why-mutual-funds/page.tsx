...
export const metadata: Metadata = {
  ...
  description:
    'Discover why mutual funds are the smartest investment for Indians. Professional management, diversification, SEBI-regulated, tax benefits under Sec 80C. Start with ₹500/month. DEEPSEA FINVEST.',
  keywords:
    'why invest mutual funds, mutual fund benefits India, SEBI regulated mutual funds, tax saving mutual funds, diversified investment India, professional fund management, SIP investment Mumbai',
};
...
const benefits = [
  {
    ...
    description:
      'Expert fund managers handle your investments with research-backed decisions.',
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description:
      'SEBI-regulated with daily NAV disclosure and portfolio transparency.',
  },
  {
    icon: PieChart,
    title: 'Affordable Access',
    description:
      'Start with as low as ₹500 and access premium stocks and bonds.',
  },
  {
    icon: Clock,
    title: 'Liquidity',
    description:
      'Easy redemption with funds credited to your account within 1-3 days.',
  },
  {
    icon: DollarSign,
    title: 'Tax Efficiency',
    description:
      'Tax benefits under Section 80C and favorable capital gains taxation.',
  },
];
...
const fundTypes = [
  ...
  {
    name: 'Debt Funds',
    description: 'Stable returns with lower risk than equity',
    risk: 'Low-Medium',
    returns: '6-8%',
  },
  {
    name: 'Hybrid Funds',
    description: 'Balance of equity and debt for moderate investors',
    risk: 'Medium',
    returns: '8-11%',
  },
  {
    name: 'Index Funds',
    description: 'Passive tracking of market indices at low cost',
    risk: 'Medium-High',
    returns: '10-13%',
  },
];
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-16">
        <p className="text-white/70 text-lg leading-relaxed">
          ...
          diversified portfolio of stocks, bonds, or other securities. They
          offer an easy and affordable way to access professional investment
          management and build long-term wealth.
        </p>
      </div>
