...
export default function ChildEducationPlannerPage() {
  ...
  const futureValueOfExisting = existingSavings * Math.pow(1 + expectedReturn / 100, yearsToGoal);
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center mb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-left">
          {[{label:'Education inflation', value:'10–12% per year'},{label:'Start planning', value:'As early as possible'},{label:'Best instrument', value:'Equity Mutual Funds'}].map(item => (
        ...
        <GlassCard className="p-8" elevated>
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-white/70 mb-2 text-sm">Child&apos;s Age: {childAge}</label>
                <input
                  type="range"
                  min="0"
                  max="15"
              ...
              <div>
                <label className="block text-white/70 mb-2 text-sm">Education Age: {educationAge}</label>
                <input
                  type="range"
                  min="16"
                  max="25"
            ...
            <div>
              <label className="block text-white/70 mb-2">Current Education Cost: {formatCurrency(currentCost)}</label>
              <input
                type="range"
                min="500000"
                max="10000000"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-white/70 mb-2 text-sm">Education Inflation: {inflation}%</label>
                <input
                  type="range"
                  min="5"
                  max="15"
        ...
        <div className="space-y-6">
          <GlassCard className="p-8" elevated>
            <div className="text-center mb-6">
              ...
              <p className="text-white/40 text-sm mt-1">for {yearsToGoal} years</p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-glass-border text-sm">
                ...
                <span className="text-white font-semibold">{formatCurrency(futureCost)}</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-glass-border text-sm">
          ...
          <GlassCard className="p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-white font-semibold mb-2">Education Planning Tips</h4>
                <ul className="space-y-2 text-white/60 text-sm">
                  <li>• Start as early as possible - even before the child is born</li>
